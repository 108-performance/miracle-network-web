      ...
      <main className="mx-auto min-h-screen max-w-4xl bg-black px-6 py-8 text-white">
        ...
        <section className="mb-8 rounded-[28px] border border-zinc-800 bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.08),_rgba(0,0,0,0.96)_60%)] p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.02)] sm:p-8">
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            >
              Start the 108 Athlete Challenge
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <ActionTile
              href="/dashboard/compete/108-athlete-challenge"
              label="Compete"
              subtext="Start your first session"
            ...
            <ActionTile
              ...
              label="Train"
              subtext="Explore the workout path"
              detail="Guest preview"
              variant="train"
            />
            ...
            <ActionTile
              href="/login"
              label="Improve"
              subtext="Create an account to unlock"
              detail="Save progress"
              variant="improve"
            />
