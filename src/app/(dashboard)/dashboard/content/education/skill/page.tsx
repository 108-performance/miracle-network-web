...
const SYSTEM_KEY = 'discover:education:skill';
  ...
  return (
    <main className="mx-auto max-w-5xl text-white">
      <section className="mb-8">
        ...
        <h1 className="mt-3 text-4xl font-extrabold">Skill</h1>
        <p className="mt-3 max-w-2xl text-zinc-400">
          Instructional content focused on skill development.
        </p>
      </section>

      {items.length === 0 ? (
        <section className="rounded-[24px] border border-white/10 bg-white/[0.04] p-6">
          <p className="text-lg font-semibold text-white">No skill content yet</p>
          <p className="mt-2 text-sm text-zinc-400">
            Add discover-routed content with the Skill subcategory in admin.
          </p>
        </section>
      ) : (
