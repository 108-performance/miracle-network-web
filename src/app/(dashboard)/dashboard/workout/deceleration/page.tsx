...
const levels = Array.from({ length: 10 }, (_, index) => ({
  title: `Level ${index + 1}`,
  href: `/dashboard/workout/deceleration/level-${index + 1}`,
}));

export default function DecelerationPage() {
  return (
    <main className="min-h-screen bg-black px-6 py-8 text-white">
      <div className="mx-auto max-w-6xl">
        <p className="mb-2 text-sm uppercase tracking-[0.2em] text-zinc-400">
          Workout / Deceleration
        </p>
        <h1 className="text-4xl font-bold">Deceleration</h1>
        <p className="mt-3 max-w-2xl text-zinc-300">
          Work through the deceleration progression and develop control,
          stability, and the ability to stop and absorb force.
        </p>
